...
<head>
    ...
    <script>
        function borrar_departamento() {
            if (confirm("¿Estás seguro de eliminar el departamento ?") == true) {
                return true;
            } else {
                return false;
            }
...
<div align="center" class="container">
    <table border="1" width="90%" class="table table-bordered border-primary" style="margin-top: 15px">
        ...
        foreach ($rows as $row) {
            ?>
            <tr>
                <td><a onclick="return borrar_departamento(<?php echo $row['']?>)"
                       href="eliminar_departamento.php?departamento=<?php echo $row['departamento']; ?>">
